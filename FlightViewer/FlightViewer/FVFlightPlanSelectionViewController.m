...
{
    [super viewDidLoad];
    self.title = self.currentAirline;
...
- (void)searchForTerm:(NSString *)query {
    ...
    userSearchingFlightPlansRequest.predicate = [NSPredicate predicateWithFormat:@"acFlightId BEGINSWITH %@ and airline = %@", query, self.currentAirline];
